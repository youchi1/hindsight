...
# OpenClaw auth-profile credential source (alternative to API keys)
ENV_LLM_AUTH_SOURCE = "HINDSIGHT_API_LLM_AUTH_SOURCE"
ENV_LLM_OPENCLAW_CONFIG_PATH = "HINDSIGHT_API_LLM_OPENCLAW_CONFIG_PATH"
ENV_LLM_OPENCLAW_AUTH_PROFILES_PATH = "HINDSIGHT_API_LLM_OPENCLAW_AUTH_PROFILES_PATH"
